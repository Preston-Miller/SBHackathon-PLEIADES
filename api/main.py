...
<html lang="en"><head>
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Cpath d='M16 2L28 7v10c0 7-5 12-12 13C5 29 4 24 4 17V7z' fill='%233fb950'/%3E%3Cpath d='M16 5L25 9v8c0 5.5-4 9.5-9 10.5C11 26.5 7 22.5 7 17V9z' fill='%230d1117'/%3E%3Cpolyline points='10.5,16.5 14,20 21.5,12.5' fill='none' stroke='%233fb950' stroke-width='2.5' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E">
  <style>{_DARK}</style>
</head><body>
  <div class="card">
